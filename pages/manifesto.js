  ...
  return (
    <div className="h-screen bg-black text-white flex flex-col">
      ...
      <div className='grow my-20 flex flex-col gap-6 justify-start mx-auto w-4/5 lg:w-3/5'>
        <h1 className='text-2xl lg:text-4xl italic'><Balancer>Manifesto</Balancer></h1>
        <div>
                <h3 className="text-left text-[#A1A1A1] font-inter font-medium leading-normal">
                    <p className="story">
            ...
            <div>
                <h2 className="text-2xl text-left text-yellow-400 font-sentient italic leading-none pt-4 pb-1 opacity-70">The Test</h2>
                <h3 className="text-left text-[#A1A1A1] font-inter font-medium leading-normal pt-4">
                    <p className="story">
            ...
            <div>
                <h2 className="text-2xl text-left text-green-400 font-sentient italic leading-none pt-4 pb-1 opacity-70">Adjectives</h2>
                <h3 className="text-left text-[#A1A1A1] font-inter font-medium leading-normal pt-4">
                    <p className="story">
            ...
            <div>
                <h2 className="text-2xl text-left text-blue-400 font-sentient italic leading-none pt-4 pb-1 opacity-70">Opportunity and Regret</h2>
                <h3 className="text-left text-[#A1A1A1] font-inter font-medium leading-normal pt-4">
                    <p className="story">
            ...
            <div>
                <h2 className="text-2xl text-left text-purple-400 font-sentient italic leading-none pt-4 pb-1 opacity-70">Imminent Questioning</h2>
                <h3 className="text-left text-[#A1A1A1] font-inter font-medium leading-normal pt-4">
                    <p className="story">
            ...
            <div>
                <h2 className="text-2xl text-left text-pink-400 font-sentient italic leading-none pt-4 pb-1 opacity-70">Resourcefulness</h2>
                <h3 className="text-left text-[#A1A1A1] font-inter font-medium leading-normal py-4">
                    <p className="story">
